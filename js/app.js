...
class Storage{
    ...
    static getMeals(defaultCalories = 0){
        let mealCalories
        if(localStorage.getItem('mealCalories') === null){
            mealCalories = defaultCalories
        }else{
            mealCalories = +localStorage.getItem('mealCalories')
        }
        return mealCalories
    }

    static updateMeals(calories){
        localStorage.setItem('mealCalories', calories)
    }
}
